<div class="p-4 sm:px-20 bg-gray-50 border-b border-gray-200">
    <div class="flex flex-col">
        ...
        <div class="my-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            <div class="flex items-start rounded-xl bg-white p-4 shadow-lg">
                ...
                <div class="ml-4">
                    <h2 class="font-semibold">0 Clients</h2>
                    <p class="mt-2 text-sm text-gray-500">Last added 2 days ago</p>
                </div>
            </div>
            ...
            <div class="flex items-start rounded-xl bg-white p-4 shadow-lg">
                ...
                <div class="ml-4">
                    <h2 class="font-semibold">0 Underwriters</h2>
                    <p class="mt-2 text-sm text-gray-500">Last added 1 day ago</p>
                </div>
            </div>
            <div class="flex items-start rounded-xl bg-white p-4 shadow-lg">
                ...
                <div class="ml-4">
                    <h2 class="font-semibold">2 Insurances</h2>
                    <p class="mt-2 text-sm text-gray-500">Last added 45 days ago</p>
                </div>
            </div>
            <div class="flex items-start rounded-xl bg-white p-4 shadow-lg">
                <div class="flex h-12 w-12 items-center justify-center rounded-full border border-red-100 bg-red-50">
        ...
        <hr class="my-2">
        <h2 class="mb-4 text-2xl font-bold">Claims</h2>
        <div class="my-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            <div class="flex items-start rounded-xl bg-white p-4 shadow-lg">
                <div class="flex h-12 w-12 items-center justify-center rounded-full border border-blue-100 bg-blue-50">
                ...
                <div class="ml-4">
                    <h2 class="font-semibold">13 Policies</h2>
                    <p class="mt-2 text-sm text-gray-500">Expiring this month</p>
                </div>
            </div>
