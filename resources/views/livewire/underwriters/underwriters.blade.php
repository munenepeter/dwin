                            ...
                            @foreach ($underwriters as $underwriter)
                                <tr class="bg-white border-b space-y-2 hover:bg-gray-100">
                                    ...
                                    <td>
                                        ...
                                        <p class="font-medium text-gray-700">{!! date('j<\s\u\p>S</\s\u\p> M y', strtotime($underwriter->updated_at)) !!}</p>

                                    </td>
                                    <td>
                                        <button title="View Underwriter"
                                            wire:click="viewUnderwriter({{ $underwriter->id }})"
                                            class="text-teal-500"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                        ...
                                        <button title="Update Underwriter"
                                            wire:click="editUnderwriter({{ $underwriter->id }})"
                                            class="text-green-500"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <button title="Delete underwriter"
                                            wire:click="deleteUnderwriter({{ $underwriter->id }})"
                                            class="text-red-500"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                class="h-4 w-4" x-tooltip="tooltip">
                                                <path stroke-linecap="round" stroke-linejoin="round"
