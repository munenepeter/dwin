<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6">
        <div class="flex justify-between h-16">
            ...
            @guest
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="#" :active="request()->routeIs('insurances')">Home</x-jet-nav-link>
                    <x-jet-nav-link href="#" :active="request()->routeIs('insurances')">About</x-jet-nav-link>
                    <x-jet-nav-link href="#" :active="request()->routeIs('insurances')">Our Covers</x-jet-nav-link>
                    <x-jet-nav-link href="#" :active="request()->routeIs('insurances')">Blog</x-jet-nav-link>
                    <x-jet-nav-link href="#" :active="request()->routeIs('insurances')">Contact</x-jet-nav-link>
                </div>
            @endguest
            @auth
